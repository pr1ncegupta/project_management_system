...
if ($result->num_rows > 0) {
    ...
    // Handle form submission to enter rating
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $student_id = $_POST['student_id'];
        $rating = $_POST['rating'];
        
        // Insert the rating into database
        $sql = "INSERT INTO ratings (student_id, guide_id, rating, date) VALUES ('$student_id', '$guide_id', '$rating', NOW())";
...
<body>
    <div class="enter-rating-container">
        <h2>Enter Rating</h2>
