...
if ($result->num_rows > 0) {
    ...
    // Handle form submission to enter attendance
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $student_id = $_POST['student_id'];
        $status = $_POST['status'];
        $date = $_POST['date']; // Get the date selected by faculty
        
        // Insert the attendance record into database
        $sql = "INSERT INTO attendance (student_id, guide_id, status, date) VALUES ('$student_id', '$guide_id', '$status', '$date')";
...
<body>
    <div class="enter-attendance-container">
